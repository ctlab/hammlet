...
@click.option(
    "--only-non-redundant-permutations",
    "is_only_non_redundant_permutations",
    is_flag=True,
    help="Use only non-redundant permutations",
)
@click.option(
...
def mle_nr(
    ...
    elif is_only_non_redundant_permutations:
        perms = "model_nr"
    else:
        perms = "model"
